...
//     //     <h1 className="text-2xl font-bold">Pedro Brito</h1>
//     //     <nav>
//     //       <ul className="flex space-x-6">
//     //         <li><Link href="#projects" className="hover:text-cyan-400">Projetos</Link></li>
//     //         <li><Link href="#skills" className="hover:text-cyan-400">Habilidades</Link></li>
//     //         <li><Link href="#contact" className="hover:text-cyan-400">Contato</Link></li>
//     //       </ul>
//     //     </nav>
//     //   </div>
//     // </header>
...
//             <Link className="font-medium text-blue-500 focus:outline-hidden" href="/" aria-current="page">Landing</Link>
//             <Link className="font-medium text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="/account">Account</Link>
//             <Link className="font-medium text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="/work">Work</Link>
//             <Link className="font-medium text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="/blog">Blog</Link>
//           </div>
//         </div>
//       </nav>
//     </header>
...
// Salve em: components/Header.tsx
...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 z-50 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white/80 backdrop-blur-sm text-sm py-3 dark:bg-gray-900">
      <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        <div className="flex items-center justify-between">
        ...
        <div className={`overflow-hidden transition-all duration-300 basis-full grow sm:block ${isMenuOpen ? 'block' : 'hidden'}`}>
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
            <Link className="font-medium text-blue-500 focus:outline-hidden" href="#projects" aria-current="page" onClick={handleLinkClick}>Projetos</Link>
